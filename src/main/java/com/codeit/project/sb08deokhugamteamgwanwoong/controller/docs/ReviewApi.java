...
public interface ReviewApi {
    ...
    @Operation(
            summary = "리뷰 좋아요 (비동기 처리)",
            description = "리뷰에 좋아요를 추가하거나 취소하는 요청을 카프카 큐에 접수합니다.",
            responses = {
                    @ApiResponse(
                            responseCode = "202",
                            description = "리뷰 좋아요 요청 접수 성공 (처리 중)",
    ...
    ResponseEntity<Void> createReviewLike( // 반환 타입을 ReviewLikeDto -> Void 로 변경
